...
// Pull data from the shared concernDataMap so cards are 1:1
const analysisMetrics: AnalysisMetric[] = [
  { label: "DAMAGE",      key: "damage",      value: 0.88, color: "#f69371", severityLabel: concernDataMap["Damage"].severityLabel,      description: concernDataMap["Damage"].description,      basedOn: concernDataMap["Damage"].basedOn },
  { label: "DRYNESS",     key: "dryness",     value: 0.82, color: "#f69371", severityLabel: concernDataMap["Dryness"].severityLabel,     description: concernDataMap["Dryness"].description,     basedOn: concernDataMap["Dryness"].basedOn },
  { label: "STRESSORS",   key: "stressors",   value: 0.58, color: "#EABF6F", severityLabel: concernDataMap["Stressors"].severityLabel,   description: concernDataMap["Stressors"].description,   basedOn: concernDataMap["Stressors"].basedOn },
  { label: "SENSITIVITY", key: "sensitivity", value: 0.3,  color: "#B9C2A6", severityLabel: concernDataMap["Sensitivity"].severityLabel, description: concernDataMap["Sensitivity"].description, basedOn: concernDataMap["Sensitivity"].basedOn },
