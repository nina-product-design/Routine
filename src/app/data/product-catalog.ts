...
export const productCatalog: Record<string, CatalogProduct> = {
  ...
  "custom-shampoo": {
    ...
    originalPrice: 35,
    isRecommended: true,
    concerns: ["Improved Hydration", "Reduced Damage", "Silky Softness"],
  ...
  "custom-conditioner": {
    ...
    originalPrice: 35,
    isRecommended: true,
    concerns: ["Improved Hydration", "Silky Softness", "Reduced Damage"],
  ...
  "custom-scalp-mask": {
    ...
    originalPrice: 49,
    isRecommended: true,
    concerns: ["Improved Hydration", "Stronger Growth"],
  ...
  "hair-oil": {
    ...
    originalPrice: 49,
    isRecommended: false,
    concerns: ["Reduced Damage", "Stronger Growth", "Improved Hydration"],
  ...
  "scalp-serum": {
    ...
    originalPrice: 56,
    isRecommended: false,
    concerns: ["Reduced Damage", "Stronger Growth", "Less Irritation"],
  ...
  "curl-cream": {
    ...
    originalPrice: 32,
    isRecommended: false,
    concerns: ["Stronger Growth", "Improved Hydration", "Silky Softness"],
  ...
  "leave-in-conditioner": {
    ...
    originalPrice: 32,
    isRecommended: false,
    concerns: ["Improved Hydration", "Silky Softness"],
  ...
  "dry-shampoo": {
    ...
    originalPrice: 32,
    isRecommended: false,
    concerns: ["Reduced Damage", "Less Irritation"],
  ...
  "styling-gel": {
    ...
    originalPrice: 32,
    isRecommended: false,
    concerns: ["Silky Softness", "Reduced Damage"],
  ...
  "hair-mask": {
    ...
    originalPrice: 49,
    isRecommended: false,
    concerns: ["Reduced Damage", "Improved Hydration", "Stronger Growth"],
